...
func (s *Service) Enroll(ctx context.Context, req *connect.Request[apiedgev1.EnrollRequest]) (*connect.Response[apiedgev1.EnrollResponse], error) {
...
func (s *Service) Rekey(ctx context.Context, req *connect.Request[apiedgev1.RekeyRequest]) (*connect.Response[apiedgev1.RekeyResponse], error) {
	...
	return connect.NewResponse(apiedgev1.RekeyResponse_builder{ServerTime: timestamppb.New(now)}.Build()), nil
}

func (s *Service) enrollResponse(edgeID string, now time.Time) *connect.Response[apiedgev1.EnrollResponse] {
