...
func (d *fakeDevice) snmpFactory(endpoint string) func(context.Context, *attachv1.DeviceCredential) (access.SNMPSession, error) {
	d.mu.Lock()
...
func (d *fakeDevice) shellFactory(endpoint string) func(context.Context, *attachv1.DeviceCredential, string) (access.ShellSession, error) {
	d.mu.Lock()
	d.endpoints = append(d.endpoints, endpoint)
	d.mu.Unlock()
	return func(_ context.Context, _ *attachv1.DeviceCredential, hostKey string) (access.ShellSession, error) {
		d.mu.Lock()
