...
import (
	...
	"go.aledante.io/FlowSeer/src/common/yang/test/integration/testenv"
)
...
func TestMain(m *testing.M) {
	...
	base, cleanup, err := testenv.StartClixon(ctx, "../../../yang/test/integration/testenv/testdata/clixon")
	cancel()
	if err != nil {
