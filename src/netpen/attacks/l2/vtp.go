...
//   - --wipe: permanent-destructive (opt-in per R15). Wipes the VLAN
//     database by pushing a summary with revision 0 and empty VLANs.
//   - --set: permanent-destructive (opt-in per R15). Overwrites the VLAN
//     database with the attacker's VLAN set.
//
