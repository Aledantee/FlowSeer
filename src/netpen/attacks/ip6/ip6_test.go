...
// mirrored TX sequences (KTD14): byte-for-byte where deterministic,
...
// ---------------------------------------------------------------------------
// DHCP starve (transient-decay, flood-class)
// ---------------------------------------------------------------------------
...
func TestDHCPStarve_FixturePins(t *testing.T) {
	...
	for i, frame := range tx {
		// KTD14: DHCP xids and chaddr are randomized fields; the
...
// ---------------------------------------------------------------------------
// Rogue DHCPv4 (transient-decay, secret-material)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Rogue DHCPv6 (transient-decay, solicit→advertise cycle)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// NDP spoof (transient-decay, field-set pin)
// ---------------------------------------------------------------------------
...
func TestNDPSpoof_FixturePins(t *testing.T) {
	...
	// The poison answer matches the reference fixture's fields (KTD14).
...
// ---------------------------------------------------------------------------
// DAD denial (transient-decay, resisted-never-failed-open)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Rogue RA (transient-decay, ~1800s lifetime)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// RA Guard (non-destructive, watch-leg traversal observation)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// RA flood (transient-decay, bounded burst, AE6)
// ---------------------------------------------------------------------------
...
// TestRAFlood_Reproducibility (AE6 in-memory shape): two runs over the
...
// ---------------------------------------------------------------------------
// MLD abuse (transient-decay, bounded burst, AE6)
// ---------------------------------------------------------------------------
...
// TestMLD_Reproducibility (AE6 in-memory shape): two runs over the
// same fixture produce the same findings class.
...
// ---------------------------------------------------------------------------
// Catalog decay-bound assertions (teardown text from the catalog row)
// ---------------------------------------------------------------------------
