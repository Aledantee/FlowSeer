...
// sequences the ip6 behaviors produce. This is the KTD14 fixture
...
//     roguera
//
// Spec-authored (no baseline craft — R4 supersets):
...
var (
	...
	// Fixed xids for deterministic fixtures (KTD14: xids masked in
...
// ---------------------------------------------------------------------------
// DHCP starve — sends DHCP DISCOVER frames with incrementing chaddr tails
...
// ---------------------------------------------------------------------------
// Rogue DHCPv4 — sends a DHCP OFFER/ACK from a rogue server.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Rogue DHCPv6 — sends a SOLICIT then an ADVERTISE response from the rogue.
...
// ---------------------------------------------------------------------------
// NDP spoof — sends a spoofed Neighbor Advertisement claiming the
...
// ---------------------------------------------------------------------------
// DAD denial — sends a Neighbor Solicitation for the target address
...
// ---------------------------------------------------------------------------
// Rogue RA — sends a Router Advertisement claiming to be a router with
...
// ---------------------------------------------------------------------------
// RA Guard — forged RA under attack (watch-leg observes it).
