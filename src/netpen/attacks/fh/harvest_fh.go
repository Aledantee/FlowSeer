...
// baseline (l2l3-audit) produces. This is the KTD14 fixture factory for the
// first-hop attack behaviors.
//
...
// ---------------------------------------------------------------------------
// Addresses used across fixtures
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// HSRP — built as raw bytes (matching netpen's owned HSRP layer SerializeTo).
// Ethernet → IP(224.0.0.2) → UDP(1985) → HSRP body.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// VRRP — built as raw bytes (gopacket's VRRPv2 has no SerializeTo).
...
// ---------------------------------------------------------------------------
// GLBP (spec-authored, RFC 7868) — built as raw bytes.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// LLDP spoof (spec-authored, IEEE 802.1AB)
// ---------------------------------------------------------------------------
