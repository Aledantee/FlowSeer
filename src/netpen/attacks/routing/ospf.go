...
// The teardown is armed before the first frame (R14).
//
// OSPF PDU paths:
...
// OSPF PDU type (KTD3: fork decoders reused; KTD5: raw craft where the fork
// is incomplete).
//
...
func RunOSPF(ctx context.Context, deps runner.Deps) error {
	...
	// --- Phase 2: Receive target's hello (adjacency formation) ---
