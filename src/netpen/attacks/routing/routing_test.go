...
// behaviors against fixture-mirrored TX sequences (KTD14): byte-for-byte
...
// ---------------------------------------------------------------------------
// OSPF (temporary-restored, goodbye/flush teardown)
// ---------------------------------------------------------------------------
...
// TestOSPF_TeardownOrder (AE2): the teardown steps execute in arm order:
...
// ---------------------------------------------------------------------------
// EIGRP (temporary-restored, goodbye teardown)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// WPAD (transient-decay, TTL-bound proxy)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// WPAD port collision (error scenario)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// OSPF PDU craft path: all raw (fork has no SerializeTo for OSPF)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Teardown step count assertions
// ---------------------------------------------------------------------------
