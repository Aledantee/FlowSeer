...
// --- AE1: permanent mode without ack refuses, zero frames, exit non-zero ---
...
// --- Acknowledged permanent: announcement record before first frame ---
...
// --- Transient-decay: announcement before execute, nothing armed ---
...
// --- Non-destructive: no announcement, no teardown ---
...
// --- AE2-shape: interrupt mid-run, teardown completes, partial failure ---
...
// --- Teardown budget: bounded total time ---
...
// --- Temporary-restored with zero steps armed: coded failure ---
...
// --- full-with-ack: permanent cannot dispatch under orchestration ---
...
// --- Signal layer: SIGINT/SIGHUP engage teardown (subprocess) ---
