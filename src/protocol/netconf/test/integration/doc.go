...
//
//	go test -short -tags yang_integration_t1 ./src/protocol/netconf/test/integration
//	go test -short -tags yang_integration_t4 ./src/protocol/netconf/test/integration
//
