...
//
//	go test ./src/protocol/restconf -run TestConformanceMatrixUpToDate -update-conformance
...
var restconfCorpus = []conformance.Row{
	{
		...
		Unit:        "restconf/integration", Status: conformance.Covered,
	},
	{
		...
		Unit:        "restconf/session", Status: conformance.Covered,
	},
	{
		ID: "rc-stale-write-conflict", Clause: "RFC 8040 §3.4.1.2",
		Provenance:  "ETag conditional-write semantics",
	...
	},
	{
		...
		Provenance:  "peers without ETag support",
	...
	},
	{
		...
		Provenance:  "clixon t1 reference server",
		Behavior:    "PUT creates and DELETE removes, each proven by re-reading the resource",
	...
	},
	{
		...
		Unit:        "restconf/lab", Status: conformance.Covered,
	},
	{
		ID: "rc-t4-identity", Clause: "device identity reads",
		Provenance:  "Ruckus ICX7150-24P, FastIron 10.0.10g, lab device 172.16.0.6",
	...
	{
		ID: "rc-t4-reversible-edit", Clause: "reversible config edit",
		Provenance:  "Ruckus ICX7150-24P, FastIron 10.0.10g, lab device 172.16.0.6",
