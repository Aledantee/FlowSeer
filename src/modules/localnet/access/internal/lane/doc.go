...
// unrelated to flowseer.device.access.v1.MutationState's central Sequence
// — Position exists before central ever assigns a sequence, and some
// admitted items (a local identity probe) never get one.
package lane
