...
// protocol-agnostic handler with one shell adapter per firmware
// (interfaces/fastiron/ is the first) — kept internal so a firmware
// adapter's types never leak past this package's facade. This package
