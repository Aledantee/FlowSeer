...
// 	protoc        (unknown)
// source: flowseer/net/ip/v1/address_origin.proto
...
func (AddressOrigin) Descriptor() protoreflect.EnumDescriptor {
	return file_flowseer_net_ip_v1_address_origin_proto_enumTypes[0].Descriptor()
}

func (AddressOrigin) Type() protoreflect.EnumType {
	return &file_flowseer_net_ip_v1_address_origin_proto_enumTypes[0]
}
...
var File_flowseer_net_ip_v1_address_origin_proto protoreflect.FileDescriptor
...
var file_flowseer_net_ip_v1_address_origin_proto_goTypes = []any{
	(AddressOrigin)(0), // 0: flowseer.net.ip.v1.AddressOrigin
}
var file_flowseer_net_ip_v1_address_origin_proto_depIdxs = []int32{
...
func init() { file_flowseer_net_ip_v1_address_origin_proto_init() }
func file_flowseer_net_ip_v1_address_origin_proto_init() {
	if File_flowseer_net_ip_v1_address_origin_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_flowseer_net_ip_v1_address_origin_proto_rawDesc), len(file_flowseer_net_ip_v1_address_origin_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_flowseer_net_ip_v1_address_origin_proto_goTypes,
		DependencyIndexes: file_flowseer_net_ip_v1_address_origin_proto_depIdxs,
		EnumInfos:         file_flowseer_net_ip_v1_address_origin_proto_enumTypes,
	}.Build()
	File_flowseer_net_ip_v1_address_origin_proto = out.File
	file_flowseer_net_ip_v1_address_origin_proto_goTypes = nil
	file_flowseer_net_ip_v1_address_origin_proto_depIdxs = nil
}
