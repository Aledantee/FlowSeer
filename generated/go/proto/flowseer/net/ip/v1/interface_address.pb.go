...
// 	protoc        (unknown)
// source: flowseer/net/ip/v1/interface_address.proto
...
func (x *InterfaceAddress) Reset() {
	*x = InterfaceAddress{}
	mi := &file_flowseer_net_ip_v1_interface_address_proto_msgTypes[0]
...
var File_flowseer_net_ip_v1_interface_address_proto protoreflect.FileDescriptor

const file_flowseer_net_ip_v1_interface_address_proto_rawDesc = "" +
	"\n" +
	"*flowseer/net/ip/v1/interface_address.proto\x12\x12flowseer.net.ip.v1\x1a\x1dflowseer/net/addr/v1/ip.proto\x1a'flowseer/net/ip/v1/address_origin.proto\x1a'flowseer/net/ip/v1/address_status.proto\"\xda\x1e\n" +
	...
	"\x16com.flowseer.net.ip.v1B\x15InterfaceAddressProtoP\x01ZBgo.aledante.io/FlowSeer/generated/go/proto/flowseer/net/ip/v1;ipv1\xa2\x02\x03FNI\xaa\x02\x12Flowseer.Net.Ip.V1\xca\x02\x12Flowseer\\Net\\Ip\\V1\xe2\x02\x1eFlowseer\\Net\\Ip\\V1\\GPBMetadata\xea\x02\x15Flowseer::Net::Ip::V1b\beditionsp\xe9\a"
...
var file_flowseer_net_ip_v1_interface_address_proto_depIdxs = []int32{
	...
	2, // 1: flowseer.net.ip.v1.InterfaceAddress.prefix:type_name -> flowseer.net.addr.v1.IpPrefix
	3, // 2: flowseer.net.ip.v1.InterfaceAddress.origin:type_name -> flowseer.net.ip.v1.AddressOrigin
...
func file_flowseer_net_ip_v1_interface_address_proto_init() {
	if File_flowseer_net_ip_v1_interface_address_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_flowseer_net_ip_v1_interface_address_proto_rawDesc), len(file_flowseer_net_ip_v1_interface_address_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_flowseer_net_ip_v1_interface_address_proto_goTypes,
		DependencyIndexes: file_flowseer_net_ip_v1_interface_address_proto_depIdxs,
		MessageInfos:      file_flowseer_net_ip_v1_interface_address_proto_msgTypes,
	}.Build()
	File_flowseer_net_ip_v1_interface_address_proto = out.File
	file_flowseer_net_ip_v1_interface_address_proto_goTypes = nil
	file_flowseer_net_ip_v1_interface_address_proto_depIdxs = nil
}
