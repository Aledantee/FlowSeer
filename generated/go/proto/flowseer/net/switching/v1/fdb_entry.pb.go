...
// 	protoc        (unknown)
// source: flowseer/net/switching/v1/fdb_entry.proto
...
func (x *FdbEntry) Reset() {
	*x = FdbEntry{}
	mi := &file_flowseer_net_switching_v1_fdb_entry_proto_msgTypes[0]
...
var File_flowseer_net_switching_v1_fdb_entry_proto protoreflect.FileDescriptor
...
var file_flowseer_net_switching_v1_fdb_entry_proto_goTypes = []any{
	(*FdbEntry)(nil),        // 0: flowseer.net.switching.v1.FdbEntry
	(*v1.Eui48Address)(nil), // 1: flowseer.net.addr.v1.Eui48Address
	(FdbEntryKind)(0),       // 2: flowseer.net.switching.v1.FdbEntryKind
	(FdbEntryStatus)(0),     // 3: flowseer.net.switching.v1.FdbEntryStatus
}
var file_flowseer_net_switching_v1_fdb_entry_proto_depIdxs = []int32{
	1, // 0: flowseer.net.switching.v1.FdbEntry.mac:type_name -> flowseer.net.addr.v1.Eui48Address
	2, // 1: flowseer.net.switching.v1.FdbEntry.kind:type_name -> flowseer.net.switching.v1.FdbEntryKind
	3, // 2: flowseer.net.switching.v1.FdbEntry.status:type_name -> flowseer.net.switching.v1.FdbEntryStatus
...
func init() { file_flowseer_net_switching_v1_fdb_entry_proto_init() }
func file_flowseer_net_switching_v1_fdb_entry_proto_init() {
	if File_flowseer_net_switching_v1_fdb_entry_proto != nil {
		return
	}
	file_flowseer_net_switching_v1_fdb_entry_kind_proto_init()
	file_flowseer_net_switching_v1_fdb_entry_status_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_flowseer_net_switching_v1_fdb_entry_proto_rawDesc), len(file_flowseer_net_switching_v1_fdb_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_flowseer_net_switching_v1_fdb_entry_proto_goTypes,
		DependencyIndexes: file_flowseer_net_switching_v1_fdb_entry_proto_depIdxs,
		MessageInfos:      file_flowseer_net_switching_v1_fdb_entry_proto_msgTypes,
	}.Build()
	File_flowseer_net_switching_v1_fdb_entry_proto = out.File
	file_flowseer_net_switching_v1_fdb_entry_proto_goTypes = nil
	file_flowseer_net_switching_v1_fdb_entry_proto_depIdxs = nil
}
