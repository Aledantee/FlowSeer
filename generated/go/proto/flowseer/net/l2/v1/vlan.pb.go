...
// 	protoc        (unknown)
// source: flowseer/net/l2/v1/vlan.proto
...
func (x *Vlan) Reset() {
	*x = Vlan{}
	mi := &file_flowseer_net_l2_v1_vlan_proto_msgTypes[0]
...
func init() { file_flowseer_net_l2_v1_vlan_proto_init() }
func file_flowseer_net_l2_v1_vlan_proto_init() {
	...
	file_flowseer_net_l2_v1_vlan_proto_depIdxs = nil
}
