...
func (EntityType) Descriptor() protoreflect.EnumDescriptor {
	return file_flowseer_api_inventory_v1_entity_proto_enumTypes[0].Descriptor()
}

func (EntityType) Type() protoreflect.EnumType {
	return &file_flowseer_api_inventory_v1_entity_proto_enumTypes[0]
}
...
func (x *EntityRef) Reset() {
	*x = EntityRef{}
	mi := &file_flowseer_api_inventory_v1_entity_proto_msgTypes[0]
...
func (x *Entity) Reset() {
	*x = Entity{}
	mi := &file_flowseer_api_inventory_v1_entity_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_flowseer_api_inventory_v1_entity_proto protoreflect.FileDescriptor
...
var file_flowseer_api_inventory_v1_entity_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_flowseer_api_inventory_v1_entity_proto_goTypes = []any{
	(EntityType)(0),   // 0: flowseer.api.inventory.v1.EntityType
	(*EntityRef)(nil), // 1: flowseer.api.inventory.v1.EntityRef
	(*Entity)(nil),    // 2: flowseer.api.inventory.v1.Entity
}
var file_flowseer_api_inventory_v1_entity_proto_depIdxs = []int32{
	0, // 0: flowseer.api.inventory.v1.EntityRef.type:type_name -> flowseer.api.inventory.v1.EntityType
	1, // 1: flowseer.api.inventory.v1.Entity.ref:type_name -> flowseer.api.inventory.v1.EntityRef
...
func init() { file_flowseer_api_inventory_v1_entity_proto_init() }
func file_flowseer_api_inventory_v1_entity_proto_init() {
	if File_flowseer_api_inventory_v1_entity_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_flowseer_api_inventory_v1_entity_proto_rawDesc), len(file_flowseer_api_inventory_v1_entity_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_flowseer_api_inventory_v1_entity_proto_goTypes,
		DependencyIndexes: file_flowseer_api_inventory_v1_entity_proto_depIdxs,
		EnumInfos:         file_flowseer_api_inventory_v1_entity_proto_enumTypes,
		MessageInfos:      file_flowseer_api_inventory_v1_entity_proto_msgTypes,
	}.Build()
	File_flowseer_api_inventory_v1_entity_proto = out.File
	file_flowseer_api_inventory_v1_entity_proto_goTypes = nil
	file_flowseer_api_inventory_v1_entity_proto_depIdxs = nil
}
