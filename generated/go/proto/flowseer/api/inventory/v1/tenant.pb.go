...
func (x *TenantRef) Reset() {
	*x = TenantRef{}
	mi := &file_flowseer_api_inventory_v1_tenant_proto_msgTypes[0]
...
func file_flowseer_api_inventory_v1_tenant_proto_init() {
	if File_flowseer_api_inventory_v1_tenant_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_flowseer_api_inventory_v1_tenant_proto_goTypes,
		DependencyIndexes: file_flowseer_api_inventory_v1_tenant_proto_depIdxs,
		MessageInfos:      file_flowseer_api_inventory_v1_tenant_proto_msgTypes,
	}.Build()
	File_flowseer_api_inventory_v1_tenant_proto = out.File
	file_flowseer_api_inventory_v1_tenant_proto_goTypes = nil
	file_flowseer_api_inventory_v1_tenant_proto_depIdxs = nil
}
