...
// 	protoc        (unknown)
// source: flowseer/device/policy/v1/handle.proto
...
func (x *AccessPolicyHandle) Reset() {
	*x = AccessPolicyHandle{}
	mi := &file_flowseer_device_policy_v1_handle_proto_msgTypes[0]
...
const file_flowseer_device_policy_v1_handle_proto_rawDesc = "" +
	"\n" +
	"&flowseer/device/policy/v1/handle.proto\x12\x19flowseer.device.policy.v1\"s\n" +
...
func init() { file_flowseer_device_policy_v1_handle_proto_init() }
func file_flowseer_device_policy_v1_handle_proto_init() {
	if File_flowseer_device_policy_v1_handle_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_flowseer_device_policy_v1_handle_proto_goTypes,
		DependencyIndexes: file_flowseer_device_policy_v1_handle_proto_depIdxs,
		MessageInfos:      file_flowseer_device_policy_v1_handle_proto_msgTypes,
	}.Build()
	File_flowseer_device_policy_v1_handle_proto = out.File
	file_flowseer_device_policy_v1_handle_proto_goTypes = nil
	file_flowseer_device_policy_v1_handle_proto_depIdxs = nil
}
