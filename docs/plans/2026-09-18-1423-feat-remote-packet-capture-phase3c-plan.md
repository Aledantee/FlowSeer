...
Files: `src/modules/capture/engine.go`, `src/edge/agent/internal/capture/subscribe.go`, `src/edge/agent/internal/capture/session.go`, `src/edge/agent/internal/capture/upload.go`, `src/edge/agent/internal/capture/capture_test.go`
After: none
